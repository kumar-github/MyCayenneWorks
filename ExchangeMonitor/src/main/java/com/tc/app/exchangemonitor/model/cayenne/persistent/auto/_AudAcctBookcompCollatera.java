...
/**
 * Class _AudAcctBookcompCollatera was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _AudAcctBookcompCollatera extends CayenneDataObject
{

	private static final long serialVersionUID = 1L;

	public static final Property<Integer> ACCT_BOOKCOMP_KEY = new Property<Integer>("acctBookcompKey");
	public static final Property<Integer> ACCT_COLLAT_NUM = new Property<Integer>("acctCollatNum");
	...
	public void setAcctCollatNum(Integer acctCollatNum)
	{
		writeProperty("acctCollatNum", acctCollatNum);
	}

	public Integer getAcctCollatNum()
	{
		return (Integer) readProperty("acctCollatNum");
	}
