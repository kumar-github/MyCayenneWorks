...
public class ExternalMappingAccountsViewModel
{
	...
	public final ObservableList<ExternalMapping> getExternalMappingAccountsObservableList()
	{
		return this.externalMappingAccountsObservableList;
	}
