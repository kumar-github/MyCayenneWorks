...
/**
 * Class _AlsRunTouch was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _AlsRunTouch extends CayenneDataObject
{

	private static final long serialVersionUID = 1L;

	public static final String TOUCH_KEY_PK_COLUMN = "touch_key";

	public static final Property<Integer> ALS_MODULE_GROUP_ID = new Property<Integer>("alsModuleGroupId");
	...
	public void setAlsModuleGroupId(Integer alsModuleGroupId)
	{
		writeProperty("alsModuleGroupId", alsModuleGroupId);
	}

	public Integer getAlsModuleGroupId()
	{
		return (Integer) readProperty("alsModuleGroupId");
	}
