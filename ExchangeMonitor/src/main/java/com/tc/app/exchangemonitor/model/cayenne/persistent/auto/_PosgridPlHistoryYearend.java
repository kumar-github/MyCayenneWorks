...
/**
 * Class _PosgridPlHistoryYearend was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _PosgridPlHistoryYearend extends CayenneDataObject
{

	private static final long serialVersionUID = 1L;

	public static final String PL_ASOF_DATE_PK_COLUMN = "pl_asof_date";
	public static final String PL_OWNER_CODE_PK_COLUMN = "pl_owner_code";
	public static final String PL_RECORD_KEY_PK_COLUMN = "pl_record_key";
	public static final String PL_TYPE_PK_COLUMN = "pl_type";
