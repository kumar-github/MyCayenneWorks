...
public class ExternalMappingUOMConversionsViewModel
{
	...
	public final ObservableList<ExternalMapping> getExternalMappingUOMConversionsObservableList()
	{
		return this.externalMappingUOMConversionsObservableList;
	}
