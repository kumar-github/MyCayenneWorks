...
public class ExternalMappingPortfoliosViewModel
{
	...
	public final ObservableList<ExternalMapping> getExternalMappingPortfoliosObservableList()
	{
		return this.externalMappingPortfoliosObservableList;
	}
