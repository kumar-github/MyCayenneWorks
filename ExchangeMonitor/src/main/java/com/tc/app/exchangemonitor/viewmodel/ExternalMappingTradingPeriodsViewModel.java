...
public class ExternalMappingTradingPeriodsViewModel
{
	...
	public final ObservableList<ExternalMapping> getExternalMappingTradingPeriodsObservableList()
	{
		return this.externalMappingTradingPeriodsObservableList;
	}
