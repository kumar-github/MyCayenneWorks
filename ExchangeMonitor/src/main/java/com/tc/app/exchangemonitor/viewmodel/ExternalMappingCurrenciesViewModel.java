...
public class ExternalMappingCurrenciesViewModel
{
	...
	public final ObservableList<ExternalMapping> getExternalMappingCurrenciesObservableList()
	{
		return this.externalMappingCurrenciesObservableList;
	}
