...
public class ExternalMappingTemplateTradesViewModel
{
	/* The below property is accessed from different controllers. */
	private final ObservableList<ExternalMapping> externalMappingTemplateTradesObservableList = FXCollections.observableArrayList();

	public final ObservableList<ExternalMapping> getExternalMappingTemplateTradesObservableList()
	{
		return this.externalMappingTemplateTradesObservableList;
	}
